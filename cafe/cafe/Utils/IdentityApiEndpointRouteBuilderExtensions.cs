...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        {
            var signInManager = sp.GetRequiredService<SignInManager<CafeUser>>();
            var _userManager = sp.GetRequiredService<UserManager<CafeUser>>();

            

            var user = await _userManager.FindByNameAsync("ayman");
    ...
    {
        private readonly RouteGroupBuilder _inner;
        public IdentityEndpointsConventionBuilder(RouteGroupBuilder inner)
        {
            _inner = inner;
        }
        private IEndpointConventionBuilder InnerAsConventionBuilder => _inner;
